...
<a href="https://dotfyle.com/Mikhaeris/dotfiles-config-nvim"><img src="https://dotfyle.com/Mikhaeris/dotfiles-config-nvim/badges/plugins?style=flat" /></a>
<a href="https://dotfyle.com/Mikhaeris/dotfiles-config-nvim"><img src="https://dotfyle.com/Mikhaeris/dotfiles-config-nvim/badges/leaderkey?style=flat" /></a>
<a href="https://dotfyle.com/Mikhaeris/dotfiles-config-nvim"><img src="https://dotfyle.com/Mikhaeris/dotfiles-config-nvim/badges/plugin-manager?style=flat" /></a>
...
```sh
git clone git@github.com:Mikhaeris/.dotfiles ~/.config/Mikhaeris/.dotfiles
```

Open Neovim with this config:

```sh
NVIM_APPNAME=Mikhaeris/.dotfiles/.config/nvim nvim
```
...
+ [aikhe/wrapped.nvim](https://dotfyle.com/plugins/aikhe/wrapped.nvim)
### statusline
...
- add in code runner and dap
 ...
 This readme was generated by [Dotfyle](https://dotfyle.com) and edited by me
